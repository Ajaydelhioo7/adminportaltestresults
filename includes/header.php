...
<head>
  ...
  <!-- Nucleo Icons -->
  <link href="<?php echo $rootUrl; ?>/admin/assets/css/nucleo-icons.css" rel="stylesheet" />
  <link href="<?php echo $rootUrl; ?>/admin/assets/css/nucleo-svg.css" rel="stylesheet" />
  <!-- Font Awesome Icons -->
  <script src="https://kit.fontawesome.com/42d5adcbca.js" crossorigin="anonymous"></script>
  <link href="/admin/assets/css/nucleo-svg.css" rel="stylesheet" />
  <!-- CSS Files -->
  <link id="pagestyle" href="<?php echo $rootUrl; ?>/admin/assets/css/soft-ui-dashboard.css?v=1.0.7" rel="stylesheet" />
  <style>
    .logoimg{
